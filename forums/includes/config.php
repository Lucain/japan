...
$config['Database']['dbname'] = 'vbulletinspark';
...
$config['Database']['technicalemail'] = 'support@quakehousing.com';
...
$config['MasterServer']['username'] = 'vbulletinspark';
$config['MasterServer']['password'] = 'Spark123!';
